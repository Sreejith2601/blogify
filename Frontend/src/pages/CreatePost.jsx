    ...
    <div className="bg-brand-bg min-h-screen py-16 sm:py-24 px-4 sm:px-6 md:px-10">
      <div className="max-w-4xl mx-auto">
        <header className="mb-16">
          <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tighter mb-3">New Story.</h1>
          <p className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">Broadcast your perspective to the global network.</p>
        </header>
